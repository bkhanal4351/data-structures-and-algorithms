...
const addExclamation = (arr) => {
  // Solution code here...
  const localArray = [];
  arr.forEach(exclamStr => {
    exclamStr = exclamStr + '!';
    localArray.push(exclamStr);
  });
  return localArray;
...
const allUpperCase = (arr) => {
  // Solution code here...
  const localArray = [];
  arr.forEach(lowerStr => {
    // lower.toUpperCase();
    localArray.push(lowerStr.toUpperCase());
  });
  return localArray;
...
const speaker = (words, callback) => {
  // Solution code here...
  const localArray = [];
  words.forEach(values => localArray.push(callback(values)));
  return localArray;
};
