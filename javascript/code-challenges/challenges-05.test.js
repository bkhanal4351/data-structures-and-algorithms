...
const toLastNames = people => {
  // Solution code here...
  let srtArr = people.map((value) => value.firstName + ' ' + value.lastName);
...
const addValues = (arr) => {
  // Solution code here...
  let arrNum = arr.reduce((previouNum, nextNum) => previouNum + nextNum, 0);
  return arrNum;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let arrNum = arr.reduce((previouNum, nextNum) => previouNum + nextNum.purchasePrice, 0);
  return arrNum;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let arrNum = arr.reduce((value) => value + 1);
...
const reversedString = (str) => {
  // Solution code here...
  let rev = str.split('');
  let revStr = rev.reduce((newStr, currentStr) => {
...
const countNumberOfChildren = (arr) => {
  const total = arr.reduce((previous, current) => {
    return previous + ( current.children ? current.children.length : 0);
  }, 0);
  return total;
};
